...
public class Page02_FirstResultPage2 {
	WebDriver driver; // null
	WebDriverWait wait; // null
public Page02_FirstResultPage2(WebDriver driver,WebDriverWait wait) {
		this.driver=driver;
		this.wait=wait;
		PageFactory.initElements(driver, this); 

}
public	@FindBy(xpath= "(//span[@class='a-size-medium a-color-base a-text-normal'])[1]")
